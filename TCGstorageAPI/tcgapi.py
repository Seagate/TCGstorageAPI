...
class Sed(object):
    ...
    def firmware_attestation(self,assessor_nonce,sub_name=None,assessor_ID=None):
        ...
        Parameters:
           assessor_nonce = A random 128 bit value generated by the Assessor (Host)
        
        Optional parameters :
            sub_name = The Common Name from the Subject Name of the Tper Attestation Certificate
            assessor_ID = A random value generated by the host
        '''
