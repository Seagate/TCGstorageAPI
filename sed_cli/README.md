...
**Root of Trust Reporting ID:** The Common Name derived from the subject name in Tper Attestation Certificate encoded in DER format (GUDID) The firmware_attestation method will fail if the RTR ID does not match
